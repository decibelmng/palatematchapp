...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Palate Match" },
      { name: "description", content: "Tap stars on bottles you've tried. Get your 5-letter palate code and bottles to pour next." },
      { name: "theme-color", content: "#1a1410" },
      { property: "og:title", content: "Palate Match" },
      { name: "twitter:title", content: "Palate Match" },
      { property: "og:description", content: "Tap stars on bottles you've tried. Get your 5-letter palate code and bottles to pour next." },
      { name: "twitter:description", content: "Tap stars on bottles you've tried. Get your 5-letter palate code and bottles to pour next." },
